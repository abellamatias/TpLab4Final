...
export const ModalUpdate = ({open, handleClose, handleSubmit}:InputProps) => {
    ...
    const initialValuesFormik={
      ...
      const validationSchema = yup.object({
        ...
        .min(1, '*No hay canchas menores a 1'),        
          ...
          const [tempValores, setTempValores] = useState<FormikValues>({dia:'', hora:'', duracion:0, tel:'', contacto:'', cancha_id:0});

          const handleSendForm = async () => {
            setOpenModalConfirmar(false);
            await handleSubmit(tempValores);
            setTempValores({dia:'', hora:'', duracion:0, tel:'', contacto:'', cancha_id:0});
